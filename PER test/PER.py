...
class PER:
	...
	def main(self):
		...
		stacked_state = self.skip_and_stack_frame(state)    #80*80*4
	...
	def experience_replay(self, state, action, reward, next_state, terminal):
		...
		if self.progress == 'Exploring':
			...
			# print 'TD_list: ', self.TD_list
			# print 'TD_error: ', TD_error
			# print 'LENGTH: ', len(self.TD_list)
